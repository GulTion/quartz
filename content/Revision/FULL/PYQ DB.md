...
columns:
  ...
  subject:
    ...
    options:
      ...
      - { label: "DS", value: "DS", color: "hsl(179, 95%, 90%)"}
      - { label: "APTI", value: "APTI", color: "hsl(22, 95%, 90%)"}
      - { label: "FULL", value: "FULL", color: "hsl(106, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  type:
    ...
    options:
      ...
      - { label: "PYQ", value: "PYQ", color: "hsl(89, 95%, 90%)"}
      - { label: "GOTS", value: "GOTS", color: "hsl(111, 95%, 90%)"}
      - { label: "MixQue", value: "MixQue", color: "hsl(35, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
